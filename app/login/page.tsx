      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-gray-100 w-full max-w-[400px] px-8 py-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="pt-3 border-t border-gray-100 dark:border-gray-800 flex flex-col items-center gap-2">
              ...
              <div className="flex flex-wrap justify-center gap-1.5">
                <button
                  type="button"
                  onClick={() => {
                    setEmail("admin@rupp.edu.kh");
                    setPassword("admin@123");
                  }}
                  className="px-2 py-1 text-[11px] font-medium bg-red-50 hover:bg-red-100 text-red-800 dark:bg-red-950 dark:text-red-300 rounded cursor-pointer"
                >
                  Admin
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail("teacher@rupp.edu.kh");
                    setPassword("teacher@123");
                  }}
                  className="px-2 py-1 text-[11px] font-medium bg-blue-50 hover:bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 rounded cursor-pointer"
                >
                  Teacher
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail("sachakponleupragna.thypheap.3624@rupp.edu.kh");
                    setPassword("student@123");
                  }}
                  className="px-2 py-1 text-[11px] font-medium bg-emerald-50 hover:bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 rounded cursor-pointer"
                >
                  Class Monitor
                </button>
                <button
                  type="button"
                  onClick={() => {
                    setEmail("student@rupp.edu.kh");
                    setPassword("student@123");
                  }}
                  className="px-2 py-1 text-[11px] font-medium bg-purple-50 hover:bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300 rounded cursor-pointer"
                >
                  Student
                </button>
              </div>
        ...
        <Link
          href="/"
          className="mt-6 text-xs font-semibold text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
        >
          ← Return to University Portal
        </Link>
      </div>
    </main>
  );
